...
- [02-Prometheus y Grafana: Stack de observabilidad en K8s](/T11%20-%20Observabilidad/Obligatorias/02-Prometheus-Grafana/1-Prometheus-Grafana.md)
- [03-Tracing: AWS X-Ray](/T11%20-%20Observabilidad/Obligatorias/03-Tracing/1-AWS-X-Ray.md)
- [04-Alerting: Alertmanager y notificaciones](/T11%20-%20Observabilidad/Obligatorias/04-Alerting/1-Alerting.md)

## Recomendadas

- [Exploración autónoma: ELK Stack, Datadog, SLO/SLI con Grafana](/T11%20-%20Observabilidad/Recomendadas/index.md)
